...
// 从环境变量获取配置
const API_ENCRYPT_ENABLE = true
const API_ENCRYPT_HEADER = 'X-Api-Encrypt'
const API_ENCRYPT_ALGORITHM =  'AES'
const API_ENCRYPT_REQUEST_KEY = '52549111389893486934626385991395' // AES密钥 或 RSA公钥
const API_ENCRYPT_RESPONSE_KEY = '96103715984234343991809655248883' // AES密钥 或 RSA私钥
