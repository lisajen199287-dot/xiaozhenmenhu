...
onMounted(() => {
  ...
  document.title = 'AI真身口播数字人 - 你的原生数字分身 - 福州市仓山区人工智能公共服务平台'
...
const steps = [
  ...
  { id: 1, title: '素材采集', desc: '手机固定拍摄一段不说话的本人视频（底片入库）' },
  { id: 2, title: '文案改写', desc: '输入文字，或通过同行链接一键智能提取改写' },
  { id: 3, title: '选声克隆', desc: '选择您的专属克隆音色或海量商业版权配音' },
  { id: 4, title: '一键出镜', desc: 'AI自动对齐口型、添加字幕与背景音乐，即刻导出成品' }
...
const scenarios = [

  {
    ...
    title: '实体门店与本地生活',
    tags: ['餐饮老板', '美业机构', '健身房'],
    description: '通过数字人批量化制作探店、日常口播，低成本覆盖同城流量，让门店全天候在线获客',
    icon: 'fas fa-store'
...

  {
    ...
    description: '快速建立专业的“个人IP”信任感。每日行业资讯播报、硬核知识解答，大幅缩短成单转化周期',
...

  {
    ...
    description: '以车间实景为背景，老板“上线”讲解产品工艺、操作指南与验厂视频，有效打消客户疑虑',
...

  {
    ...
    description: '自动化课程录制与长视频转短视频，只需输入文案即可多语种出镜，一人活成一支视频团队',
  ...
  <div class="dh-landing">
    ...
    <header class="hero" id="hero-section">
        ...
        <div class="container hero-content">
          ...
          <p class="subtitle">避免镜头焦虑，由AI驱动专属真身，为您输出自然流畅的高质量口播视频</p>
    ...
    <section class="section-padding bg-white">
      ...
      <div class="container">
        ...
        <div class="scenario-grid-premium">
          ...
          <div v-for="(scene, index) in scenarios" :key="index" class="premium-card">
    ...
    <section class="advantages section-padding dark-bg">
      ...
      <div class="container">
        ...
        <div class="adv-list">
          ...
          <div v-for="(adv, index) in advantages" :key="index" class="adv-item" :class="{ 'reverse': index % 2 !== 0 }">
      ...
      <div class="container">
        ...
        <div class="form-wrapper">
          ...
          <div class="form-content-left">
            ...
            <h2>开始构建您<br><span class="highlight-text">数字分身私域体系</span></h2>
            ...
            <div class="trust-features">
              ...
              <div class="trust-feat-item">
                ...
                <div>
                  ...
                  <p>基于原生底片，AI 像素级对齐口型，确保每一个发音细节都自然真实</p>
              ...
              <div class="trust-feat-item">
                ...
                <div>
                  ...
                  <p>签署法律合规协议，素材库独立加密存储，全方位保障数字资产安全</p>
          ...
          <div class="form-container-right">
            ...
            <div v-if="submitted" class="success-message">
              ...
              <p>我们的数字化专家将在 24 小时内与您联系，<br>并为您开通演示体验账号</p>

              <button class="btn-reset" @click="submitted = false">重新填写</button>
            ...
            <form v-else class="consult-form" @submit.prevent="submitForm">
              ...
              <div class="form-group">
                ...
                <input v-model="formData.company" type="text" placeholder="怎么称呼您的组织或品牌">
              ...
              <div class="form-row">
                ...
                <div class="form-group">
                  ...
                  <input v-model="formData.name" type="text" placeholder="输入姓名" required>
                ...
                <div class="form-group">
                  ...
                  <input v-model="formData.phone" type="tel" placeholder="用于接收测试账号" required>
              ...
              <div class="form-group">
                ...
                <textarea v-model="formData.demand" rows="3" placeholder="例如：我们要制作短视频投流、或者做数字人直播等.."></textarea>
              ...
              <p class="privacy-note"><i class="fas fa-lock"></i> 您的隐私信息受企业级安全策略保护</p>
...
.privacy-note i { color: #10b981; margin-right: 4px; }
