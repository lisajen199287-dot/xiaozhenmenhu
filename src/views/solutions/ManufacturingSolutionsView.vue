...
const employees = [
  {
    ...
    desc: "极速解析千页PDF与复杂矢量图纸的结构关系。只要开口询问，即可在乱麻般的技术档案中精准拎出操作指南",

    skills: ["超大文本处理中心", "多模态图文解析", "复杂工程参数计算"],
...

  {
    ...
    desc: "巡检遭遇红灯告警，手机一扫即可结合过往相似工单给出高成功率拆解替换路径分析",

    skills: ["故障归因链网", "智能工单提取", "高维排障检测"],
...

  {
    ...
    desc: "告别低效死板的报表排班，AI 基于突发暴增订单数、原材价格波动等多因素进行全局预测给出最优调度",

    skills: ["算力全局寻优", "插单动态平滑调度", "产能极大化压榨"],
...

  {
    ...
    desc: "使用更高维度的多模态监督学习剔除瑕疵，抗环境光线与微小震动干扰能力极其卓越",

    skills: ["小样本隐形提炼", "无定形瑕疵捕捉", "错位防漏极致把控"],
  ...
  <div class="ecommerce-page">
    ...
    <header class="eco-hero">
      ...
      <div class="wrapper hero-content">
        <span class="badge">Manufacturing Solution</span>

        <h1>制造业解决方案</h1>

        <p>基于前沿AI大模型，让隐性机理知识跃然显性，构建智慧数字工厂</p>
    ...
    <section class="section-intro wrapper">
      <div class="intro-grid">
        <div class="intro-text">
          ...
          <div class="pain-point-list">
            <div class="pain-item">
              ...
              <span
                ><strong>经验传承断层深：</strong
                >核心工艺与隐形调试秘籍掌握在少数老专家脑中，新人培训周期极为漫长</span
              >
            </div>
            ...
            <div class="pain-item">
              ...
              <span
                ><strong>生产异常排查慢：</strong
                >设备故障排查往往依赖人工翻阅海量纸质操作说明与巡检报告，停机损失巨亿</span
              >
            </div>
            ...
            <div class="pain-item">
              ...
              <span
                ><strong>供应链联动割裂：</strong
                >采购、库房与产线存在数据壁垒，无法基于供需预测进行灵敏的最佳寻优排产</span
              >
            </div>
          </div>
        </div>
        ...
        <div class="intro-highlight">
          <h3>AI 赋能 · 大脑级中枢指挥系统</h3>

          <p>
            告别靠人填报表、凭直觉开机的作坊模式。利用私有化大模型疯狂喂收海量工业机理图册、工艺标准与历史故障工单，打造每一位机修工身边的全知数字向导与全局决策智脑
          </p>
        </div>
      </div>
    </section>
...
.eco-hero {
  ...
  background: linear-gradient(rgba(15, 23, 42, 0.55), rgba(15, 23, 42, 0.55)),
    url("@/assets/images/factory-bg.png");
