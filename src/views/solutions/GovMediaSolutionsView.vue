    ...
    <section class="section-intro wrapper">
      <div class="intro-grid">
        <div class="intro-text">
          ...
          <div class="pain-point-list">
            <div class="pain-item">
              ...
              <span
                ><strong>深度公文写作耗时</strong
                >公文起草需要极高严谨度，人工从拟草到多轮校对耗时巨大，文字生产力难以释放</span
              >
            </div>
            ...
            <div class="pain-item">
              ...
              <span
                ><strong>视频新闻生产滞后</strong
                >传统剪辑模式无法满足突发事件及高频宣传的分钟级制播需求，人力物力消耗极高</span
              >
            </div>
            ...
            <div class="pain-item">
              ...
              <span
                ><strong>政策引用与解读工作量大：</strong
                >撰写高规格公文需引用海量政策制度，人工查阅与解读周期长，极易发生引用偏差</span
              >
            </div>
          </div>
        </div>
        ...
        <div class="intro-highlight">
          ...
          <p>
            以“大模型写作助手”为核心，通过“政策解读助手”提供准确引用，利用“知识资产库”激活历史数据，并最终借助“视频生产工厂”实现全媒体爆发，构建起一套从文字起草到视频宣传的高效内容治理体系
          </p>
        </div>
      </div>
    </section>
    ...
    <section class="section-roles">
      <div class="wrapper">
        <div class="section-title">
          ...
          <p>
            从精准公文起草到多模态内容产出，构建机关企事业单位高效办公新范式
          </p>
        </div>
...
.eco-hero {
  ...
  background: linear-gradient(rgba(15, 23, 42, 0.55), rgba(15, 23, 42, 0.55)),
    url("@/assets/images/media-bg.png");
