...
const employees = [
  {
    ...
    desc: "基于金牌销冠话术库深度学习，为新入职人员提供 7x24 仿真对抗演练；接待现场由 AI 实时转写并推送最佳破冰与逼单建议",

    skills: ["销冠话术仿真", "实时旁路辅助", "对话质量全量复盘"],
...

  {
    ...
    desc: "打破高昂的实拍与剪辑成本，AI 可根据车型亮点及流行模板，一键生成极具社交传播力的短视频、3D 动效渲染短片与多语种带货素材",

    skills: ["爆款视频模板", "3D 车型渲染视频", "跨平台自动化发布"],
...

  {
    ...
    desc: "深度整合数万页车型手册、竞品对比及政策文件，通过 Agent 赋能数字人或智能终端，提供秒级的、极其专业且有情感的问答交互",

    skills: ["复杂参数秒答", "多维竞品对比", "多模态意图识别"],
...

  {
    ...
    desc: "将社交素材消耗与门店线索转化深度归因，实时监测全链路 ROI。AI 大脑自动优化投放策略，从流量爆发到订单转化实现全闭环运营",

    skills: ["线索精准分发", "ROI 实时监控", "全链路数据打通"],
  ...
  <div class="ecommerce-page">
    ...
    <header class="eco-hero">
      ...
      <div class="wrapper hero-content">
        <span class="badge">Auto Industry Solution</span>

        <h1>汽车行业解决方案</h1>

        <p>基于前沿 AI 大模型，重塑购车体验与线索转化效率</p>
    ...
    <section class="section-intro wrapper">
      <div class="intro-grid">
        <div class="intro-text">
          ...
          <div class="pain-point-list">
            <div class="pain-item">
              ...
              <span
                ><strong>营销视频制作慢：</strong
                >新车上市需要海量短视频覆盖矩阵号，传统实拍和后期剪辑模式效率低、成本高，难以饱和攻击流量池。</span
              >
            </div>
            ...
            <div class="pain-item">
              ...
              <span
                ><strong>销售专业度不齐</strong
                >门店顾问水平差异大，销冠话术难以快速复制给全员，导致大量到店意向流失</span
              >
            </div>
            ...
            <div class="pain-item">
              ...
              <span
                ><strong>专业知识门槛高：</strong
                >三电系统、自动驾驶等专业知识繁多，消费者询问时往往得不到即时且极具信服力的解答</span
              >
            </div>
          </div>
        </div>
        ...
        <div class="intro-highlight">
          ...
          <p>
            深度整合 AIGC
            视觉生成与大语言模型专家能力，将传统“人盯人”的低效模式升级为“AI
            素材工厂 + AI 销冠对练 + 专家知识库”的数智化驱动体系，彻底重塑车企
            content 运营与转化链路
          </p>
        </div>
      </div>
    ...
    <section class="section-roles">
      <div class="wrapper">
        <div class="section-title">
          <h2>车企 AIGC 增长全景引擎</h2>

          <p>
            从社交媒体爆款物料量产，到门店销售能力升级，构建全链路数智化闭环
          </p>
        </div>
