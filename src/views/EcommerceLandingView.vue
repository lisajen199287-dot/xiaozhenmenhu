...
const categories = [
  ...
  { 
    ...
    image: 'https://images.unsplash.com/photo-1539109139745-f61b1ca002fd?auto=format&fit=crop&q=80&w=600'
  ...
  { 
    ...
    image: 'https://images.unsplash.com/photo-1515562141207-7a88fb0ce33e?auto=format&fit=crop&q=80&w=600'
...
const props = defineProps({
  ...
  title: { type: String, default: 'AI电商视觉实验- 您的全能AI电商摄影| CII AI' },

  description: { type: String, default: 'CII AI电商视觉实验室为电商卖家提供一站式AI做图解决方案，包含AI模特换装、场景生成、抠图、超清放大等工具箱，10秒生成高转化商业海报 '}
...
onMounted(() => {
  ...
  metaKeywords.setAttribute('content', 'AI电商, AI模特, 虚拟试衣, AI商品 电商外挂, 智能抠图, 商业摄影, CII AI')

})

const handleFeilianRedirect = () => {
  window.location.href = 'https://feilian.aics.cii-group.com/api/oauth2/authorize?client_id=clNTFblwUdlnWlqnOTtEsOqNouoZYBXNfWPZvVMm&redirect_uri=https://spscznsc.aics.cii-group.com&response_type=code'
}
</script>
...
<template>
  ...
  <div class="eco-landing">
      ...
      <div class="wrapper">
        ...
        <div class="hero-text">
          ...
          <p class="hero-subtitle">
            ...
            专为电商卖家打造。无需高薪聘请模特与摄影团队，告别繁琐 PS 抠图 <br/>
          ...
          <div class="hero-cta">
            ...
            <button class="btn-primary-large" @click="handleFeilianRedirect">免费生成高转化商品图</button>
        ...
        <div class="hero-visual">
          ...
          <div class="comparison-slider">
            ...
            <div class="comparison-slider-inner">
              ...
              <img src="https://images.unsplash.com/photo-1542291026-7eec264c27ff?auto=format&fit=crop&q=80&w=800" alt="CII AI 生成的商业级运动鞋摄影大片" class="image-after" />

              <div class="before-container" :style="{ width: sliderValue + '%' }">

                 <img src="https://images.unsplash.com/photo-1542291026-7eec264c27ff?auto=format&fit=crop&q=80&w=800&grayscale=1" alt="普通手机拍摄的原始运动鞋照片" class="image-before" />

              </div>

              <input type="range" min="0" max="100" v-model="sliderValue" class="slider-input" />
      ...
      <div class="wrapper">
        ...
        <div class="industry-grid">
          ...
          <div v-for="cat in categories" :key="cat.id" class="industry-card">
            ...
            <div class="card-image" :style="{ backgroundImage: `url(${cat.image})` }">
      ...
      <div class="wrapper">
        ...
        <div class="feature-block">
          ...
          <div class="feature-info">
            ...
            <p class="feature-desc">模特随心换，海量外籍/国模一键生成，彻底告别侵权风险</p>
          ...
          <div class="feature-visual">
             ...
             <div class="model-swap-demo">
                ...
                <img src="https://images.unsplash.com/photo-1617137968427-85924c800a22?auto=format&fit=crop&q=80&w=600" alt="CII AI 虚拟模特换装演示" />
        ...
        <div class="feature-block reverse">
          ...
          <div class="feature-visual">
            ...
            <div class="scene-grid">
               ...
               <img src="https://images.unsplash.com/photo-1595150983630-d39763740e53?auto=format&fit=crop&q=80&w=400" alt="AI生成的香水商业海报 - 沙滩场景" />

               <img src="https://images.unsplash.com/photo-1523275335684-37898b6baf30?auto=format&fit=crop&q=80&w=400" alt="AI生成的智能手表摄影大片 - 高级光影" />
    ...
    <section class="eco-pricing" id="pricing">
      ...
      <div class="wrapper">
        ...
        <div class="section-header">
          ...
          <h2 class="section-title">为什么头部大卖都在用 [CII AI]</h2>
    ...
    <section class="eco-final-cta">

      <div class="wrapper">

        <h2 class="cta-title">现在注册，立即解锁电商爆款的流量密码</h2>

        <p class="cta-subtitle">新用户注册即送 50 个免费生成点数，无需绑定信用卡</p>

        <button class="btn-primary-shiny" @click="handleFeilianRedirect">立即领取免费额度</button>
